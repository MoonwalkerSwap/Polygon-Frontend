...
import { Button, Modal } from 'polygon-moonwalkerswap-uikit'
    ...
    <Modal title={TranslateString(450, 'Enter amount of tickets to buy')} onDismiss={onDismiss}>
      ...
      <div>
        <Announce>
          {TranslateString(
            478,
            'Ticket purchases are final. Your pDUST cannot be returned to you after buying tickets.',
          )}
        </Announce>
